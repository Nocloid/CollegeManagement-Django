...
class Session(models.Model):
    ...
    def __str__(self):
        return "From " + str(self.inicio) + " to " + str(self.final)
...
class Student(models.Model):
    ...
    def __str__(self):
        return self.admin.nombre + " " + self.admin.apellido
...
class Subject(models.Model):
    nombre = models.CharField(max_length=120)
    docente = models.ForeignKey(Staff,on_delete=models.CASCADE,)
...
class FeedbackStudent(models.Model):
    student = models.ForeignKey(Student, on_delete=models.CASCADE)
    retroalimentación = models.TextField()
